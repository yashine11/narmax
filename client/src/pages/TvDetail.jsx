      ...
      <div className="relative min-h-[60vh] lg:min-h-[70vh] flex items-end pb-12 pt-28 overflow-hidden">
        {show.trailer?.key ? (
          ...
          <>
            <iframe
              ref={trailerRef}
              src={`https://www.youtube.com/embed/${show.trailer.key}?autoplay=1&mute=1&controls=0&playsinline=1&rel=0&modestbranding=1&loop=1&playlist=${show.trailer.key}&enablejsapi=1`}
            ...
            <div className="absolute bottom-4 right-4 z-30 flex items-center gap-2 bg-black/60 backdrop-blur-md border border-white/10 rounded-full px-3 py-1.5 shadow-xl">
              ...
              >−</button>
              <div
                className="w-16 relative h-1.5 bg-white/20 rounded-full overflow-hidden cursor-pointer"
                onClick={(e) => {
