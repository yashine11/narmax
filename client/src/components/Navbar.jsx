      ...
      >
        <div className="mx-auto flex h-16 max-w-[1920px] items-center gap-3 px-4 sm:h-20 sm:gap-6 sm:px-8">
          ...
          <div className="hidden items-center gap-3 md:flex">
            ...
            {/* Desktop Profile Dropdown (outside capsule) */}
            <div ref={profileRef} className="relative">
              {user ? (
                ...
                >
                  <img
                    ...
                    loading="lazy"
                  />
                  <ChevronDownIcon className={`h-3.5 w-3.5 text-zinc-300 transition ${profileOpen ? 'rotate-180' : ''}`} />
                </button>
              ) : (
                <Link
                  to="/login"
              ...
              {profileOpen && user && (
                <div className="animate-rise-fade absolute right-0 top-full z-[200] mt-3 w-64 rounded-2xl border border-white/15 bg-black/90 p-3 shadow-2xl backdrop-blur-2xl sm:w-72">
